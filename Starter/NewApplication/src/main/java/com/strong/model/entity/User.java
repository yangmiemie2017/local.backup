...
public class User implements Serializable {
    ...
    public Set<UserAuthority> getAuthorities() {
    	List<String> acc=Arrays.asList(this.userAccesses.split(","));
    	acc.forEach(x->authorities.add(new UserAuthority(x,x,x)));
	...
	public String getUserAccesses() {
		return userAccesses;
	}
	public void setUserAccesses(String userAccesses) {
		this.userAccesses = userAccesses;
	}
	public List<String> getUserAccessesList(){
		return Arrays.asList(this.userAccesses.split(","));
	}
}
